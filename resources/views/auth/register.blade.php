            ...
            <div class="col-lg-12 col-xl-12">
                <div class="card login-shell">
                    <div class="row no-gutters">
                        <div class="col-lg-7 d-none d-lg-flex login-hero p-4 p-xl-5 flex-column justify-content-between">
                            <div class="hero-badge mb-4">
                                <i class="fas fa-user-shield"></i>
                            </div>
                            <div>
                                <h3 class="font-weight-bold mb-3">{{ $appName }}</h3>
                                <p class="mb-0" style="opacity:.9;">Buat akun baru untuk mulai mengelola aplikasi dengan aman.</p>
                            </div>
                            ...
                            <div class="card login-card">
                                <div class="card-body p-4 p-md-5">
                                    <div class="text-center mb-4">
                                        @if ($logo)
                                            <img src="{{ $logo }}" alt="Logo {{ $appName }}" class="brand-logo mb-3">
                                        @else
                                            <div class="mb-3">
                                    ...
                                    <form method="POST" action="{{ route('register') }}" class="mb-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                                    name="name" value="{{ old('name') }}" placeholder="Masukkan nama lengkap" required autocomplete="name" autofocus>
                                            </div>
                                            @error('name')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                                    name="email" value="{{ old('email') }}" placeholder="nama@email.com" required autocomplete="email">
                                            </div>
                                            @error('email')
                                                <small class="text-danger d-block mt-1">{{ $message }}</small>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            <label for="password-confirm" class="font-weight-600">Konfirmasi Password</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
